...
CONFIG = os.path.join(os.path.dirname(os.path.dirname(__file__)), ".upptimerc.yml")
HISTORY_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "history")
OUTPUT = os.path.join(os.path.dirname(os.path.dirname(__file__)), "status-dashboard.html")
